...
\begin{itemize}
  \item Adapt your C/C++ program by wrapping your main method into a \texttt{extern "C" \{ … \}} block. Here is an excerpt of the source code of the tarit model provided in this package, in the folder \texttt{src}:
  \begin{verbatim}
  extern "C" {
...
\begin{itemize}
  ...
  \item  if it is a binary executable file \\
