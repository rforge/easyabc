...
Alternatively, \texttt{ABC\_rejection} can be used to solely launch the model simulations and to store the simulation outputs without performing the rejection step.
