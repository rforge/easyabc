...
\date{\texttt{EasyABC} version  1.1 \Sexpr{Sys.Date()} }
...
Intermediary results consist in the progressive writing of simulation outputs for the functions \texttt{ABC\_rejection} and \texttt{ABC\_mcmc} and in the writing of intermediary results at the end of each step for the function \texttt{ABC\_sequential}.
...
n=10
tolerance=c(1.5,0.5)
ABC_Beaumont<-ABC_sequential(method="Beaumont", model=toy_model, prior=toy_prior, nb_simul=n, summary_stat_target=sum_stat_obs, tolerance_tab=tolerance)
@
...
tolerance=0.5
c_drov=0.7
ABC_Drovandi<-ABC_sequential(method="Drovandi", model=toy_model, prior=toy_prior, nb_simul=n, summary_stat_target=sum_stat_obs, tolerance_tab=tolerance, c=c_drov)
@
...
alpha_delmo=0.5
tolerance=0.5
ABC_Delmoral<-ABC_sequential(method="Delmoral", model=toy_model, prior=toy_prior, nb_simul=n, summary_stat_target=sum_stat_obs, alpha=alpha_delmo, tolerance_target=tolerance)
@
...
n=10
pacc=0.4
ABC_Lenormand<-ABC_sequential(method="Lenormand", model=toy_model, prior=toy_prior2, nb_simul=10, summary_stat_target=sum_stat_obs, p_acc_min=pacc)
@
...
All these arguments have default values (see the package help for the function ABC_mcmc), so that \texttt{ABC\_mcmc} will work without user-defined values.
<<ABC_Marjoram_original>>=
n=10
ABC_Marjoram_original<-ABC_mcmc(method="Marjoram_original", model=toy_model, prior=toy_prior, summary_stat_target=sum_stat_obs, n_rec=n)
@
...
This way of automatic determination of $dist\_max$, $tab\_normalization$ and $proposal\_range$ is strongly recommended, compared to the crude automatic determination proposed in the method "Marjoram_original".
<<ABC_Marjoram>>=
n=10
ABC_Marjoram<-ABC_mcmc(method="Marjoram", model=toy_model, prior=toy_prior, summary_stat_target=sum_stat_obs, n_rec=n)
@
...
<<#ABC_Wegmann>>=
n=10
ABC_Wegmann<-ABC_mcmc(method="Wegmann", model=toy_model, prior=toy_prior, summary_stat_target=sum_stat_obs, n_rec=n)
@
...
n=10
p=0.2
ABC_rej<-ABC_rejection(model=toy_model_parallel, prior=toy_prior, nb_simul=n, summary_stat_target=sum_stat_obs, tol=p, n_cluster=2, use_seed=TRUE)
@
...
rej<-abc(sum_stat_obs, ABC_rej$param[,c(2,3,5,6)], ABC_rej$stats, tol=0.2, method="rejection")
# simulations selected:
rej$unadj.values
# their associated summary statistics:
rej$ss
...
n=10
tolerance=c(8,5)
ABC_Beaumont<-ABC_sequential(method="Beaumont", model=trait_model, prior=trait_prior, nb_simul=n,
summary_stat_target=sum_stat_obs, tolerance_tab=tolerance, use_seed=TRUE)
@
...
tolerance=3
c_drov=0.7
ABC_Drovandi<-ABC_sequential(method="Drovandi", model=trait_model, prior=trait_prior, nb_simul=n,
summary_stat_target=sum_stat_obs, tolerance_tab=tolerance, c=c_drov, use_seed=TRUE)
@
...
alpha_delmo=0.5
tolerance=3
ABC_Delmoral<-ABC_sequential(method="Delmoral", model=trait_model, prior=trait_prior, nb_simul=n,
summary_stat_target=sum_stat_obs, alpha=alpha_delmo, tolerance_target=tolerance, use_seed=TRUE)
@
...
n=10
pacc=0.4
ABC_Lenormand<-ABC_sequential(method="Lenormand", model=trait_model, prior=trait_prior, nb_simul=n, 
summary_stat_target=sum_stat_obs, p_acc_min=pacc, use_seed=TRUE)
@
...
<<ABC_Marjoram_original>>=
n=10
ABC_Marjoram_original<-ABC_mcmc(method="Marjoram_original", model=trait_model, prior=trait_prior,
summary_stat_target=sum_stat_obs, n_rec=n, use_seed=TRUE)
@
...
n_calib=10
tol_quant=0.2 
ABC_Marjoram<-ABC_mcmc(method="Marjoram", model=trait_model, prior=trait_prior,  summary_stat_target=sum_stat_obs,
...
n_calib=10
tol_quant=0.2 
ABC_Wegmann<-ABC_mcmc(method="Wegmann", model=trait_model, prior=trait_prior,  summary_stat_target=sum_stat_obs,
n_rec=n, n_calibration=n_calib, tolerance_quantile=tol_quant, use_seed=TRUE)
@
